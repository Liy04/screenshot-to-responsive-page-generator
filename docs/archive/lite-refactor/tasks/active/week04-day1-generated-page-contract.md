...
- 更新 `docs/specs/generated-page-artifact-v0.1.md`。
- 更新 `docs/specs/layout-to-html-v0.1.md`。
- 必要时同步 `docs/plans/week-04.md`。
- 明确 validator 失败处理口径。
...
- `docs/tasks/active/week04-day1-generated-page-contract.md`
